...
func createApp() (*App, error) {
	...
	shiYuanUsecase := usecase.NewShiYuanUsecase(logger, fileUsecase)
	crawlerHandler := v1.NewCrawlerHandler(echo, baseHandler, authMiddleware, logger, configConfig, crawlerUsecase, notionUseCase, epubUsecase, wikiJSUsecase, feishuUseCase, confluenceUsecase, yuqueUsecase, shiYuanUsecase)
